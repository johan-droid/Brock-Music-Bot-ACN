...
from app.core.call import init_calls
from app.core.queue import init_queue_manager
...
from app.utils.resilience import global_watchdog, log_error, notify_owner
...
async def _cleanup_streaming_stack(logger: logging.Logger) -> None:
    ...
    try:
        from app.core.userbot import stop_userbots
    ...
    try:
        from app.utils.time_manager import time_manager
...
async def _assistant_bootstrap_loop(logger: logging.Logger) -> None:
    ...
    while True:
        try:
            ...
            from app.core import call
            from app.plugins.play import on_track_end
...
async def _main_impl():
    ...
    try:
        ...
        try:
            from app.core.bot import stop_bot
