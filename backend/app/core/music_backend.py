...
from app.core.microservice_client import MusicMicroserviceClient
from app.platforms.web_fallback import resolve_url as resolve_fallback_url
from app.platforms.web_fallback import search_tracks as search_fallback_tracks
from app.utils.circuit_breaker import source_health_tracker
from app.utils.errors import FallbackExhaustedError, DelegationRequested
from app.utils.title_detector import build_title_routing_hints
...
def _get_multi_cache():
    from app.utils.multi_tier_cache import multi_cache
