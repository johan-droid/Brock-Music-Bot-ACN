...
async def init_database():
    ...
    if neon_url:
        try:
            from app.utils.neon_db import init_neon
            init_neon(neon_url)
            
            import app.utils.neon_db as _neon_module
...
def _init_sqlite_fallback():
    ...
    global db, DB_MODE
    try:
        from app.utils.sqlite_db import init_sqlite_db
        init_sqlite_db(config.SQLITE_DB_PATH)
        
        import app.utils.sqlite_db as _sqlite_module
