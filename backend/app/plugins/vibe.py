...
from app.ai_search import vibe_search
from app.utils.permissions import rate_limit, require_member
from app.core.music_backend import music_backend
from app.plugins.play import add_track_and_play, _show_conflict_options
