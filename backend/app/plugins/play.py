...
from app.utils.permissions import rate_limit, require_member, require_admin, get_permission_level
from app.utils.formatters import format_duration, truncate_text
from app.utils.thumbnails import generate_np_thumbnail
from app.utils.effects_engine import get_active_effect, process_track
from app.utils.title_detector import conflict_resolver, normalize_text, calculate_similarity
from app.utils.progress_tracker import progress_tracker
from app.utils.cache import cache
from app.utils.live_ui import soul_king_ui
from app.utils.soul_king_thumbnail import soul_king_thumbnail
from app.utils.metrics import metrics_collector
from app.platforms import extract_audio
from app.core.queue import queue_manager
from app.core import call
from app.core import bot as bot_module
from app.core.music_backend import music_backend, Track
from app.utils.errors import summarize_exception
from app.utils.errors import DelegationRequested
from app.utils.http_pool import HTTPConnectionPool
from app.config_loader import config
from app.utils.resilience import global_watchdog, log_error
...
def _rank_candidates_for_selection(query: str, candidates: list) -> list:
    ...
    from app.core.music_backend import SourceRanker, calculate_track_quality, Track
...
async def play_cmd(client: Client, message: Message):
    ...
    if not query and message.reply_to_message:
        ...
        if reply.audio or reply.voice or reply.video:
            from app.platforms.telegram import TelegramAudioHandler
...
async def add_track_and_play(
    ...
    if settings.get("voting_mode", False):
        from app.plugins.anon_requests import start_vote_session
        from app.core.bot import app
...
async def _send_now_playing(chat_id: int, track: dict, user_id: int = None) -> None:
    ...
    try:
        ...
        user_level = 1
        if user_id:
            from app.utils.permissions import get_permission_level
            ...
            if duration > 0 and (duration - elapsed) <= 15 and not has_prefetched and q_size > 0:
                ...
                try:
                    ...
                    if queue_data:
                        ...
                        from app.core.music_backend import Track
                        next_track = Track(
